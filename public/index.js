document.addEventListener('DOMContentLoaded', () => {
    ...
    const content = {
        home: `
            <h2>About Me</h2>
            <p class="about-me">Hi, I'm <span style="color:var(--color-green)">Jaylyn Green</span>, and I’m deeply passionate about <span style="color:var(--color-purple)">technology</span> and its power to transform lives. With a degree in Information Technology, I’ve built a strong foundation in various tech domains. Over the years, I’ve <span style="color:var(--color-orange)">honed</span> my expertise in software <span style="color:var(--color-blue)">development</span>, with a particular focus on <span style="color:var(--color-purple)">frontend</span> development. Crafting intuitive and <span style="color:var(--color-green)">visually</span> appealing user interfaces is not just a skill for me, it’s a way to combine <span style="color:var(--color-blue)">creativity</span> and problem-solving to enhance user experiences. I thrive on <span style="color:var(--color-purple)">learning</span> and applying new technologies to solve real-world problems, making me excited about every <span style="color:var(--color-orange)">oppurtunity</span> to contribute and grow in this ever-evolving field.</br></br></br>Take a look at my resume here => <a style="color:var(--color-orange)" href="https://docs.google.com/document/d/1pBVBJdlmwBLvcfEmZ3GIvUQkLCV4nB8o/edit" target="_blank">resume</a></br>Here's my <a style="color:var(--color-green)" href="https://www.linkedin.com/in/jaylyn-green-0b4086242/" target="_blank">LinkedIn</a>!</br>You can also view my work on GitHub here => <a style="color:var(--color-purple)" href= "https://github.com/jaylyn-green" target= '_blank'>GitHub</a></br></br>Take a look at the <span style="color:var(--color-orange)">section</span> on the left to <span style="color:var(--color-green)">explore</span> my work and experience!</p>
